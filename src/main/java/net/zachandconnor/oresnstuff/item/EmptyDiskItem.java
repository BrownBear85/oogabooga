...
public class EmptyDiskItem extends OresnstuffModElements.ModElement {
	@ObjectHolder("oresnstuff:empty_disk")
	public static final Item block = null;
	public EmptyDiskItem(OresnstuffModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Can you even put it in a jukebox?"));
		}
	}
}
