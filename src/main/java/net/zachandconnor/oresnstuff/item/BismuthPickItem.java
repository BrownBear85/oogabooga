...
public class BismuthPickItem extends OresnstuffModElements.ModElement {
	@ObjectHolder("oresnstuff:bismuth_pick")
	public static final Item block = null;
	public BismuthPickItem(OresnstuffModElements instance) {
		super(instance, 8);
	}
