...
public class SpectrolitePickItem extends OresnstuffModElements.ModElement {
	@ObjectHolder("oresnstuff:spectrolite_pick")
	public static final Item block = null;
	public SpectrolitePickItem(OresnstuffModElements instance) {
		super(instance, 11);
	}
