...
public class BismuthnuggetItem extends OresnstuffModElements.ModElement {
	@ObjectHolder("oresnstuff:bismuthnugget")
	public static final Item block = null;
	public BismuthnuggetItem(OresnstuffModElements instance) {
		super(instance, 5);
	}
