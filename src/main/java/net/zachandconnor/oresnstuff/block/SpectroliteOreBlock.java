...
package net.zachandconnor.oresnstuff.block;

import net.zachandconnor.oresnstuff.item.SpectroliteItem;
...
public class SpectroliteOreBlock extends OresnstuffModElements.ModElement {
	@ObjectHolder("oresnstuff:spectrolite_ore")
	public static final Block block = null;
	public SpectroliteOreBlock(OresnstuffModElements instance) {
		super(instance, 19);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("oresnstuff:spectrolite_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("oresnstuff:spectrolite_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
