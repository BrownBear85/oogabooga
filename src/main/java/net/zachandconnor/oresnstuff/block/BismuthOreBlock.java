...
import net.zachandconnor.oresnstuff.item.BusmuthItem;
...
public class BismuthOreBlock extends OresnstuffModElements.ModElement {
	@ObjectHolder("oresnstuff:bismuth_ore")
	public static final Block block = null;
	public BismuthOreBlock(OresnstuffModElements instance) {
		super(instance, 18);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("oresnstuff:bismuth_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("oresnstuff:bismuth_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
