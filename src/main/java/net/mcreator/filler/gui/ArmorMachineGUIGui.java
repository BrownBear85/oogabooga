...
public class ArmorMachineGUIGui extends FillerModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("armor_machine_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, ArmorMachineGUIGuiWindow::new));
	}
		...
		if (buttonID == 0) {
			{
				...
				ArmorButtonClickedProcedure.executeProcedure($_dependencies);
			}
		}
	}
