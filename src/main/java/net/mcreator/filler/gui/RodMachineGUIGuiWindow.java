...
@OnlyIn(Dist.CLIENT)
public class RodMachineGUIGuiWindow extends ContainerScreen<RodMachineGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = RodMachineGUIGui.guistate;
	public RodMachineGUIGuiWindow(RodMachineGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("filler:textures/rod_machine_gui.png");
	@Override
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 114, this.guiTop + 52, 45, 20, new StringTextComponent("Fuse"), e -> {
			if (true) {
				FillerMod.PACKET_HANDLER.sendToServer(new RodMachineGUIGui.ButtonPressedMessage(0, x, y, z));
				RodMachineGUIGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
