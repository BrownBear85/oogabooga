...
public class RGBYellowBiome extends FillerModElements.ModElement {
	public static Biome biome;
	public RGBYellowBiome(FillerModElements instance) {
		super(instance, 159);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("filler:rgb_yellow"));
			}
		}
	}
	@Override
