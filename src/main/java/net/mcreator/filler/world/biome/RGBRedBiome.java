...
public class RGBRedBiome extends FillerModElements.ModElement {
	public static Biome biome;
	public RGBRedBiome(FillerModElements instance) {
		super(instance, 156);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("filler:rgb_red"));
			}
		}
	}
	@Override
