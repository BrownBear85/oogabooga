...
public class RGBGreenBiome extends FillerModElements.ModElement {
	public static Biome biome;
	public RGBGreenBiome(FillerModElements instance) {
		super(instance, 160);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("filler:rgb_green"));
			}
		}
	}
	@Override
