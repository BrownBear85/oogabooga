...
public class RGBBlueBiome extends FillerModElements.ModElement {
	public static Biome biome;
	public RGBBlueBiome(FillerModElements instance) {
		super(instance, 161);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("filler:rgb_blue"));
			}
		}
	}
	@Override
