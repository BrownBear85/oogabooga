...
import net.mcreator.filler.procedures.BismuthBlockRedstoneOnProcedure;
...
public class BismuthBlockBlock extends FillerModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77\u00A7oThis block looks alien"));
		}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					BismuthBlockRedstoneOnProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
