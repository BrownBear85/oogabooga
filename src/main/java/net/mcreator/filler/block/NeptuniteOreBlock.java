...
import net.mcreator.filler.item.NeptuniteItem;
...
public class NeptuniteOreBlock extends FillerModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(150f, 1600f).setLightLevel(s -> 0)
					.harvestLevel(7).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("neptunite_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(NeptuniteItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("filler:neptunite_ore_match"), () -> CustomRuleTest.codec);
