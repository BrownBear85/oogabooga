...
public class NeptunitePickaxeItem extends FillerModElements.ModElement {
	@ObjectHolder("filler:neptunite_pickaxe")
	public static final Item block = null;
	public NeptunitePickaxeItem(FillerModElements instance) {
		super(instance, 74);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("neptunite_pickaxe"));
	}
}
