...
public class BiotiteItem extends FillerModElements.ModElement {
	@ObjectHolder("filler:biotite")
	public static final Item block = null;
	public BiotiteItem(FillerModElements instance) {
		super(instance, 13);
	}
