...
public class BiotiteNuggetItem extends FillerModElements.ModElement {
	@ObjectHolder("filler:biotite_nugget")
	public static final Item block = null;
	public BiotiteNuggetItem(FillerModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("biotite_nugget");
		}
