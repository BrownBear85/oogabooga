...
public class NeptuniteItem extends FillerModElements.ModElement {
	@ObjectHolder("filler:neptunite")
	public static final Item block = null;
	public NeptuniteItem(FillerModElements instance) {
		super(instance, 16);
	}
